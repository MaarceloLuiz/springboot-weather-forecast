...
public class MarkdownService {
    public String generateWeatherMarkdown(WeatherForecast forecast){
        ...
        markdown.append("<tr><th>Date</th><th>Weather</th><th>Condition</th><th>Moon Phase</th><th>Moon Visualization</th><th>Temperature</th><th>Wind</th></tr>\n");
        ...
        forecast.getForecast().forEach(weatherData -> {
            ...
            markdown.append("<tr>")
                    ...
                    .append("<td><img src=\"").append(weatherData.getMoonImg()).append("\" alt=\"Moon Phase Visualization\" style=\"width:50px; height:50px; display:block; margin:auto;\"/></td>")
